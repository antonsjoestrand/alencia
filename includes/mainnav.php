<?php
$about_us_active = (isset($about_us_active)) ? "active" : "";
$bridges_active = (isset($bridges_active)) ? "active" : "";
$gondolas_active = (isset($gondolas_active)) ? "active" : "";
$news_active = (isset($news_active)) ? "active" : "";
$contact_us_active = (isset($contact_us_active)) ? "active" : "";
?>
...
<nav class="nav">
    <ul class="nav__list">
        ...
        <li class="nav__listitem"><a href="about_us.php" id="<?=$about_us_active?>">About us</a></li>
        <li class="nav__listitem"><a href="bridges.php">Projects</a>
            <ul class="nav__listitemdrop">
                <li><a href="bridges.php" id="<?=$bridges_active?>">Bridges</a></li>
                <li><a href="gondolas.php" id="<?=$gondolas_active?>">Gondolas</a></li>
            </ul>
        </li>
        <li class="nav__listitem"><a href="news.php" id="<?=$news_active?>">News</a></li>
        <li class="nav__listitem"><a href="contact_us.php" id="<?=$contact_us_active?>">Contact us</a></li>
    </ul>
